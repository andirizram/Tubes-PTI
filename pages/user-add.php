...
<body>
        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              <li class="scroll-to-section">
                <a href="admin-role.php" class="active">ROLE</a>
              </li>
              <li class="scroll-to-section">
  ...
  <div class="swiper-container-table" id="top">
    ...
    <iframe class="user-add" src="../add-user/index.html" width="100%" style="margin-top: 100px; height: 500px" height="400"></iframe>
  </div>
